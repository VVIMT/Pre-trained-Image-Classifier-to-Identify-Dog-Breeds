...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("% Match: " + str(results_stats_dic['pct_match']))
    ...
    if print_incorrect_dogs == True \
            and n_correct_dogs + n_correct_notdogs != n_images:
        print("\nMisclassified Dogs")

        incorrect_dogs = 0
        for key, value in results_dic.items():
            if sum(results_dic[key][3:]) == 1:
                print(" Pet Image: {}".format(results_dic[key][0]))
                print(" Pet Classifier: {}".format(results_dic[key][1]))  
                print("----------")
                incorrect_dogs += 1
        print("Number of Incorrect Dogs: " + str(incorrect_dogs))
    ...
    if print_incorrect_breed == True and n_correct_dogs != n_correct_breed:
        ...
        for key, value in results_dic.items():
            if sum(results_dic[key][3:]) == 2 and results_dic[key][2] == 0:
                ...
                print("----------")
                incorrect_breed += 1
        print("Number of Incorrect Breeds: " + str(incorrect_breed))
